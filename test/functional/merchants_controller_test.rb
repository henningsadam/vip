...
class MerchantsControllerTest < ActionController::TestCase
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post :create, merchant: { company_name: @merchant.company_name, dba_name: @merchant.dba_name, merchant_id: @merchant.merchant_id }
    end
  ...
  test "should update merchant" do
    put :update, id: @merchant, merchant: { company_name: @merchant.company_name, dba_name: @merchant.dba_name, merchant_id: @merchant.merchant_id }
    assert_redirected_to merchant_path(assigns(:merchant))
  end
