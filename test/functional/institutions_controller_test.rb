...
class InstitutionsControllerTest < ActionController::TestCase
  ...
  test "should create institution" do
    assert_difference('Institution.count') do
      post :create, institution: { institution_name: @institution.institution_name }
    end
  ...
  test "should update institution" do
    put :update, id: @institution, institution: { institution_name: @institution.institution_name }
    assert_redirected_to institution_path(assigns(:institution))
  end
